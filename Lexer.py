...
def lexicalAnalyzer(input_string):
    ...
    tokens = []             # create a list of tuples to store the tokens


    while input_string:     # Loop through the input string until it is empty
